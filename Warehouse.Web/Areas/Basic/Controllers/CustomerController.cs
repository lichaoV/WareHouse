...
namespace Warehouse.Web.Controllers
{
    ...
    public partial class CustomerController : BaseController
    {
        ...
        {
            var vm = CreateVM<CustomerListVM>();
        ...
        public ActionResult Edit(CustomerVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        {
            var vm = CreateVM<CustomerBatchVM>(Ids: IDs);
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("批量修改")]
        public ActionResult DoBatchEdit(CustomerBatchVM vm, IFormCollection nouse)
        {
        ...
        {
            var vm = CreateVM<CustomerImportVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("导入")]
        public ActionResult Import(CustomerImportVM vm, IFormCollection nouse)
        {
